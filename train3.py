...
OPTIMIZER=SGDAccum(lr=MIN_LR, accum_iters=ACCUM_ITERS)
#OPTIMIZER=SGD(lr=MIN_LR, decay=0.000225, momentum=0.5)
#OPTIMIZER=Adam(lr=MIN_LR)

INITIAL_WEIGHT = 'logs/002/trained_weights_stage_2.h5'
