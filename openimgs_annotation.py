...
def main():
    cls_list, cls_desc = get_class_descriptions('open-image-dataset/kaggle-2019-object-detection/challenge-2019-classes-description-500.csv')
    ids, annotations = get_annotations('open-image-dataset/kaggle-2019-object-detection/challenge-2019-train-detection-bbox.csv', cls_list)
    ### for testing
